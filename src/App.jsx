...
export default function App() {
  ...
  const handleAmountChange = (e) => {
    ...
    setAmount(value);
    const tokens = parseFloat(value || 0) * 5000;
    setTokenOut(tokens);
  };

  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      <div className="w-full max-w-lg px-6 py-8 bg-zinc-900 rounded-xl shadow-xl">
        <div className="text-center mb-6">
          <h2 className="text-2xl md:text-3xl font-bold">BUY $HVMD</h2>
          <p className="text-sm text-gray-400 mt-1">Stage 12 · 85.62% Complete</p>
        ...
        <button
          ...
          className="w-full py-3 bg-orange-500 hover:bg-orange-600 rounded text-black font-bold text-lg"
        >
